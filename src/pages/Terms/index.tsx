...
import { FileText, CheckCircle, AlertTriangle, Shield, Users, CreditCard, Truck, RotateCcw, Globe, Mail, Phone, Calendar } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            <FileText className="h-12 w-12 text-lion-500 mr-3" />
        ...
        <div className="bg-lion-500 text-white rounded-lg p-6 mb-12 max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div>
              <h3 className="font-semibold mb-2">{t('summary.keyPoints')}</h3>
            ...
            <div>
              <h3 className="font-semibold mb-2">{t('summary.important')}</h3>
              <ul className="space-y-1 text-lion-100">
                <li>• {t('summary.important1')}</li>
                <li>• {t('summary.important2')}</li>
                <li>• {t('summary.important3')}</li>
                <li>• {t('summary.important4')}</li>
              </ul>
            </div>
          </div>
        </div>
