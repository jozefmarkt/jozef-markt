      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex space-x-8 border-t border-gray-200 pt-4">
            <Link
              to="/admin"
              className="flex items-center space-x-2 px-3 py-2 text-sm font-medium text-indigo-600 border-b-2 border-indigo-600"
            >
            ...
            <Link
              to="/admin/products"
              className="flex items-center space-x-2 px-3 py-2 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-b-2 hover:border-gray-300"
            >
