...
const SectionHero = () => {
  ...
  return (
  <section className="relative isolate bg-cover bg-center bg-[url('/hero%20banner.png')] after:absolute after:inset-0 after:bg-jet/60 min-h-screen overflow-hidden">
    {/* Animated background image */}
    <motion.div
      className="absolute inset-0 bg-cover bg-center"
      style={{
        backgroundImage: "url('/hero%20banner.png')",
